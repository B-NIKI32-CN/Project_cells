...
while running:
    ...
    for event in pg.event.get():
        ...
        if scene == 'game':
            ...
            if players_flag:
                for i in range(n):
                    players.append(Player(i, INITIAL_RESOURCES))
                player = players[turn]
                players_flag = False
